...
h|*0..1*
|*reminder*: `REMINDER_CHAIN`
a|Time window after moment of initial availability during which the action may be started, i.e. an 'acceptable delay'. Allows approximate times to be used operationally.
|===
