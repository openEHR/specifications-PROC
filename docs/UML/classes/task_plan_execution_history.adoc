...
h|*0..1*
|*task_events*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<<<_task_event_record_class,TASK_EVENT_RECORD>>>`
a|Task-level execution time events.

h|*0..1*
|*plan_events*: `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<<<_task_plan_event_record_class,TASK_PLAN_EVENT_RECORD>>>`
