...
h|*Inherit*
2+|`link:/releases/RM/{proc_release}/common.html#_authored_resource_class[AUTHORED_RESOURCE^]`, `link:/releases/RM/{proc_release}/ehr.html#_content_item_class[CONTENT_ITEM^]`
