...
h|*Inherit*
2+|`link:/releases/BASE/{proc_release}/resource.html#_authored_resource_class[AUTHORED_RESOURCE^]`, `link:/releases/RM/{proc_release}/ehr.html#_content_item_class[CONTENT_ITEM^]`
...
h|*0..1*
|*care_pathway*: `link:/releases/RM/{proc_release}/data_structures.html#_item_structure_class[ITEM_STRUCTURE^]`
...
h|*0..1*
|*care_plan*: `link:/releases/BASE/{proc_release}/base_types.html#_locatable_ref_class[LOCATABLE_REF^]`
...
h|*0..1*
|*event_wait_states*: `link:/releases/BASE/{proc_release}/foundation_types.html#_list_class[List^]<<<_event_wait_class,EVENT_WAIT>>>`
a|Reference list of all defined Event Listeners.

h|*0..1*
|*top_level_plans*: `link:/releases/BASE/{proc_release}/foundation_types.html#_list_class[List^]<<<_task_plan_class,TASK_PLAN>>>`
...
h|*0..1*
|*order_list*: `link:/releases/BASE/{proc_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{proc_release}/foundation_types.html#_string_class[String^],<<_order_ref_class,ORDER_REF>>>`
