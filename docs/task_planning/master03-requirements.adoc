...
The discussion above provides a guide as to what should potentially be modelled in a task plan. Rather than necessarily 'everything' (i.e. every possible step as per the medical textbook), it is:
