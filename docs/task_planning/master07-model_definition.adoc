...
* `SUBJECT_PRECONDITION._expression_`;
* `DECISION_BRANCH._test_expression_`;
...
[.text-center]
.proc.task_planning package definition model (timing view)
image::{uml_export_dir}/diagrams/PROC-task_planning.definition-timing.svg[id=proc_task_planning_definition_timing, align="center"]
...
include::{uml_export_dir}/classes/callback_wait.adoc[]
...
include::{uml_export_dir}/classes/state_condition.adoc[]
