...
image::diagrams/conceptual_decision_based.svg[id=conceptual_decision_based, align="center"]
...
image::diagrams/conceptual_condition_based.svg[id=conceptual_condition_based, align="center"]
