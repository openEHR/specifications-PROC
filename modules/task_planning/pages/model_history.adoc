...
image::ROOT:uml/PROC-task_planning.history.svg[id=proc_task_planning_history, align="center"]
...
include::ROOT:partial$classes/task_plan_execution_history.adoc[]

include::ROOT:partial$classes/event_record.adoc[]

include::ROOT:partial$classes/task_plan_event_record.adoc[]

include::ROOT:partial$classes/task_event_record.adoc[]

include::ROOT:partial$classes/task_notification_record.adoc[]
