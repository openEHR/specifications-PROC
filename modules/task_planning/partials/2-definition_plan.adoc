...
image::diagrams/work_task_plans.svg[id=work_task_plans, align="center", width=50%]
...
image::ROOT:uml/PROC-TaskStateMachine.svg[id=task_state_machine, align="center", width=80%]
...
include::ROOT:partial$classes/task_lifecycle.adoc[leveloffset=+1]
...
include::ROOT:partial$classes/work_plan.adoc[leveloffset=+1]

include::ROOT:partial$classes/plan_calendar.adoc[leveloffset=+1]

include::ROOT:partial$classes/plan_timeline.adoc[leveloffset=+1]

include::ROOT:partial$classes/calendar_entry.adoc[leveloffset=+1]

include::ROOT:partial$classes/task_plan.adoc[leveloffset=+1]

include::ROOT:partial$classes/task_participation.adoc[leveloffset=+1]

include::ROOT:partial$classes/plan_item.adoc[leveloffset=+1]

include::ROOT:partial$classes/task_repeat.adoc[leveloffset=+1]
