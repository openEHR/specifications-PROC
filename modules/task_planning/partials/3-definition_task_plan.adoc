...
image::diagrams/task_group_sequential.svg[id=task_group_sequential, align="center", width=45%]
...
[.text-center]
.Parallel Task Group
image::diagrams/task_group_parallel.svg[id=task_group_parallel, align="center", width=25%]
...
|`and_all_paths`     
a|image::diagrams/task_group_parallel_and.svg[id=task_group_parallel_and]
|AND                |All branches are followed. |Group completes when all branches complete.

|`xor_one_path`     
a|image::diagrams/task_group_parallel_xor.svg[id=task_group_parallel_xor]
...
|`or_all_started`    
a|image::diagrams/task_group_parallel_or_all.svg[id=task_group_parallel_or_all]
...
|`or_first_completed`
a|image::diagrams/task_group_parallel_or_first.svg[id=task_group_parallel_or_first]
...
image::diagrams/task_grouping2.svg[id=task_grouping2, align="center", width=75%]
...
include::ROOT:partial$classes/task_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/execution_type.adoc[leveloffset=+1]

include::ROOT:partial$classes/concurrency_mode.adoc[leveloffset=+1]

include::ROOT:partial$classes/execution_rule.adoc[leveloffset=+1]
