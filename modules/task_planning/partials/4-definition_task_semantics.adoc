...
include::ROOT:partial$classes/task.adoc[leveloffset=+1]

include::ROOT:partial$classes/dispatchable_task.adoc[leveloffset=+1]

include::ROOT:partial$classes/performable_task.adoc[leveloffset=+1]
