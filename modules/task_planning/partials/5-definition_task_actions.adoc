...
image::ROOT:uml/PROC-task_planning.definition-actions.svg[id=rm_definition_actions, align="center"]
...
|`DEFINED_ACTION`
a|image::diagrams/task-defined_task.svg[id=task_defined_task]
|An inline-defined Task to be performed by the principal performer of the Group (see below for details);

|`SUB_PLAN`
a|image::diagrams/task-sub_plan.svg[id=task_sub_plan]
...
|`SYSTEM_REQUEST`
a|image::diagrams/task-system_request.svg[id=task_system_request]
...
|`HAND_OFF`
a|image::diagrams/task-hand_off.svg[id=task_hand_off]
...
|`EXTERNAL_REQUEST`
a|image::diagrams/task-external_request.svg[id=task_external_request]
...
image::ROOT:uml/PROC-task_planning.definition-defined_task.svg[id=proc_task_planning_definition_defined_task, align="center", width=50%]
...
[.text-center]
.Task definition
image::diagrams/task_definition.svg[id=task_definition, align="center", width=55%]
...
include::ROOT:partial$classes/task_action.adoc[leveloffset=+1]

include::ROOT:partial$classes/subject_precondition.adoc[leveloffset=+1]

include::ROOT:partial$classes/performable_action.adoc[leveloffset=+1]

include::ROOT:partial$classes/resource_participation.adoc[leveloffset=+1]

include::ROOT:partial$classes/defined_action.adoc[leveloffset=+1]

include::ROOT:partial$classes/sub_plan.adoc[leveloffset=+1]

include::ROOT:partial$classes/dispatchable_action.adoc[leveloffset=+1]

include::ROOT:partial$classes/hand_off.adoc[leveloffset=+1]

include::ROOT:partial$classes/external_request.adoc[leveloffset=+1]

include::ROOT:partial$classes/system_request.adoc[leveloffset=+1]

include::ROOT:partial$classes/linked_plan.adoc[leveloffset=+1]
