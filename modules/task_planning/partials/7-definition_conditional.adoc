...
image::ROOT:uml/PROC-task_planning.definition-decision.svg[id=proc_task_planning_definition_decision, align="center"]
...
include::ROOT:partial$classes/choice_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/override_type.adoc[leveloffset=+1]

include::ROOT:partial$classes/choice_branch.adoc[leveloffset=+1]

include::ROOT:partial$classes/condition_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/condition_branch.adoc[leveloffset=+1]

include::ROOT:partial$classes/decision_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/decision_branch.adoc[leveloffset=+1]

include::ROOT:partial$classes/adhoc_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/adhoc_branch.adoc[leveloffset=+1]

include::ROOT:partial$classes/event_group.adoc[leveloffset=+1]

include::ROOT:partial$classes/event_branch.adoc[leveloffset=+1]
